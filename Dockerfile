...
RUN set -e; \
    ...
    VER=$(curl -sf https://api.github.com/repos/nushell/nushell/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    RUST_ARCH=$(cat /tmp/RUST_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/starship/starship/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    RUST_ARCH=$(cat /tmp/RUST_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/ajeetdsouza/zoxide/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    RUST_ARCH=$(cat /tmp/RUST_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/eza-community/eza/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    ...
    VER=$(curl -sf https://api.github.com/repos/junegunn/fzf/releases/latest | grep tag_name | cut -d'"' -f4); \
    CLEAN_VER="${VER#v}"; \
...
RUN set -e; \
    GO_ARCH=$(cat /tmp/GO_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/carapace-sh/carapace-bin/releases/latest | grep tag_name | cut -d'"' -f4); \
    CLEAN_VER="${VER#v}"; \
...
RUN set -e; \
    GO_ARCH=$(cat /tmp/GO_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/direnv/direnv/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    RUST_ARCH=$(cat /tmp/RUST_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/sharkdp/bat/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    RUST_ARCH=$(cat /tmp/RUST_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/BurntSushi/ripgrep/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    RUST_ARCH=$(cat /tmp/RUST_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/sharkdp/fd/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    RUST_ARCH=$(cat /tmp/RUST_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/jesseduffield/lazygit/releases/latest | grep tag_name | cut -d'"' -f4); \
    CLEAN_VER="${VER#v}"; \
...
RUN set -e; \
    RUST_ARCH=$(cat /tmp/RUST_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/sxyazi/yazi/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    RUST_ARCH=$(cat /tmp/RUST_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/max-sixty/worktrunk/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    GO_ARCH=$(cat /tmp/GO_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/dlvhdr/gh-dash/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    ...
    VER=$(curl -sf https://api.github.com/repos/jdx/mise/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    RUST_ARCH=$(cat /tmp/RUST_ARCH); \
    VER=$(curl -sf https://api.github.com/repos/atuinsh/atuin/releases/latest | grep tag_name | cut -d'"' -f4); \
...
RUN set -e; \
    VER=$(curl -sf https://api.github.com/repos/ryanoasis/nerd-fonts/releases/latest | grep tag_name | cut -d'"' -f4); \
